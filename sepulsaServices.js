...
const sepulsaGetCallOfDuty = async () => {
  try {
    const configForPost = {
      url: "https://api.sepulsa.com/api/v1/carts/add/",
      headers: {
      ...
      data: "{\"url\":\"http://api.sepulsa.com/api/v1/oscar/products/708/\",\"quantity\":1,\"options\":[{\"option\":\"https://api.sepulsa.com/api/v1/oscar/options/1/\",\"value\":\"1231231231231\"}]}",
      method: "POST",
    };
...
const sepulsaGetLordsMobile = async () => {
  try {
    const configForPost = {
      url: "https://api.sepulsa.com/api/v1/carts/add/",
      headers: {
      ...
      data: "{\"url\":\"http://api.sepulsa.com/api/v1/oscar/products/746/\",\"quantity\":1,\"options\":[{\"option\":\"https://api.sepulsa.com/api/v1/oscar/options/1/\",\"value\":\"1231231231231\"}]}",
      method: "POST",
    };
...
const sepulsaGetMarvelSuperWar = async () => {
  try {
    const configForPost = {
      url: "https://api.sepulsa.com/api/v1/carts/add/",
      headers: {
      ...
      data: "{\"url\":\"http://api.sepulsa.com/api/v1/oscar/products/2274/\",\"quantity\":1,\"options\":[{\"option\":\"https://api.sepulsa.com/api/v1/oscar/options/1/\",\"value\":\"1231231231231\"}]}",
      method: "POST",
    };
...
const method = sepulsaBody["FF"];


console.log(method("7693574908"));
